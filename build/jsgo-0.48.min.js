...
GenericObject=function GenericObject(b,c,d){if(b.constructor!=String)throw TypeError("className must be String");var f=0,e={},k={},h={},g={},m={};this.header={};var l={};for(i in c){c[i].type="undefined"==typeof c[i].type?"typeless":c[i].type;try{GenericObject.validateAttribute(c[i])}catch(n){return console.error(n),null}var p=c[i].name.replace(/\ |\./g,"_");l[p]={type:c[i].type,notNull:c[i].notNull,useCast:c[i].useCast,objectConstructor:c[i].objectConstructor}}Object.defineProperty(this.header,"format",
{value:l,writable:!1,enumerable:!0,configurable:!1});Object.defineProperty(this.header,"className",{value:b,writable:!1,enumerable:!0,configurable:!1});this.size=function(){return f};for(i in c)b=c[i].name.replace(/\ |\./g,"_"),this[b]={name:b,value:null},f++,e[b]=void 0==c[i].type?"undefined":c[i].type,g[b]="number"==typeof c[i].maxSize?c[i].maxSize:null,k[b]=!0==c[i].notNull?!0:!1,h[b]=!0==c[i].useCast?!0:!1,m[b]=void 0==c[i].objectConstructor?null:c[i].objectConstructor,this[b].validate=function(b){var c=
...
GenericObject.typesLibrary={typeless:{validate:function(a){return!0}},string:{validate:function(a){return"string"==typeof a},cast:function(a){return"object"==typeof a?a.toSource():String(a)}},number:{validate:function(a){return"number"==typeof a&&!isNaN(a)},cast:function(a){return Number(a)}},"boolean":{validate:function(a){return"boolean"==typeof a},cast:function(a){return Boolean(a)}},"function":{validate:function(a){return"function"==typeof a}},object:{validate:function(a){return"object"==typeof a}},array:{validate:function(a){return"object"==
...
var g=[],g=b.collection instanceof GenericObjectCollection?b.collection.objects.slice():b.collection.slice(),k=0;for(i in g)if("string"!=typeof a&&g instanceof a||"*"==a||g[i].header.className==a){if(d.process(g[i]))switch(b.query.type){case JSGO.METHOD.SELECT:e.push(b.selectedAttributes(g[i]));break;case JSGO.METHOD.UPDATE:var l=b.__whenUpdate(b.query.selection,i),e=e?!0:l;break;case JSGO.METHOD.DELETE:b.collection.objects.splice(k,1);k--;e=!0;break;default:throw Error("Query type doesn't exist. Use the JSGO.METHOD enum");
}k++}null!=b.orderby&&b.__whenOrderBy(e,b.orderby.attribute,b.orderby.order);return e};if(b.query.type==JSGO.METHOD.UPDATE)return e.Set=function(){var a={};b.query.updateTo=arguments;a.run=k;return a},e;b.query.type==JSGO.METHOD.SELECT&&(e.OrderBy=function(a,c){var d={};b.orderby={attribute:a,order:c};d.run=k;return d});e.run=k;return e};return d}};
...
this.query.updateTo[attr],e=collection.objects[b][a[attr]].info().type,g=this.collection.objects[b],h="On UPDATE: Attribute "+a[attr]+" doesn't accepts "+h+" as a valid value\n",h=h+("\tCollection index: "+b+"\n"),h=h+("\tAttribute type: "+e+"\n"),h=h+"\tObject:\n";console.warn(h,g)}return c}});GenericObjectCollection.Query.prototype.Delete=function(a){this.query.selection=[];a={};this.query.type=JSGO.METHOD.DELETE;a.From=this.fromFunc;return a};GO={query:{}};GO.query.type={SELECT:0,DELETE:1,UPDATE:2};
GO.query.op={TAUTOLOGICAL:0,CONTRADICTORY:1,EQ:2,NEQ:3,GT:4,GTE:5,MT:6,MTE:7,LIKE:8,HAS:9};GO.query.order={ASC:0,DESC:1};
GO.Query=function(a){this.collection=a;var b={type:null,selection:null,from:null,where:null,updateTo:[],orderby:null};this._getRecord=function(){return b};this._setRecord=function(a,d){b[a]=d};this.select=function(){query.type=GO.query.type.SELECT;query.selection=[];query.selection.push(arguments);return new GO.Query._From(this)};this.update=function(){query.type=GO.query.type.UPDATE;return new GO.Query._From(this)};this["delete"]=function(){query.type=GO.query.type.DELETE;return new GO.Query._From(this)}};
GO.Query._From=function(a){this.from=function(b){"undefined"==typeof b&&(b=Object);a._setRecord("from",b);return new GO.Query._Where(a)}};GO.Query._Where=function(a){this.filter=null;switch(a._getRecord().type){case GO.query.type.SELECT:this.orderBy=function(b,c){a._setRecord("orderby",{attribute:b,order:c})};break;case GO.query.type.UPDATE:this.set=function(){}}this.where=function(a){this.filter=a}};
GO.Query.Filter=function(a,b,c){this.attribute=a;this.operator=b;this.value=c;var d=null,f={and:null,or:null,xor:null},e=function(a,b,c,d){for(var e in f)e==a?(f[i]=new GO.Query.Filter(b,c,d),f[i]._setParent(this)):f[i]=null;return f[a]};this._setParent=function(a){d=a};this.parent=function(){return d};this.child=function(){return f.and||f.or||f.xor};this.root=function(){for(var a=null;null!=this.parent();)a=this.parent();return a};this.isEmpty=function(){return null==typeof this.attribute&&null==
typeof this.operator&&null==typeof this.value};this.and=function(a,b,c){return e("and",a,b,c)};this.or=function(a,b,c){return e("or",a,b,c)};this.xor=function(a,b,c){return e("xor",a,b,c)}};GO.Query._Processor=function(a,b){this.run=function(){return[]}};