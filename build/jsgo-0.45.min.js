...
GenericObjectCollection.Query=function(a){var b=this;this.collection=a;this.lastQuery=null;this.query={type:null,selection:null,from:null,where:null,updateTo:[],orderby:null};this.fromFunc=function(a){var d={};b.query.from=a;d.Where=function(d){d=d.toRoot();var e={};b.query.where={attribute:d.attribute,operator:d.operator,value:d.value};var k=function(){var e=!1;b.query.type==JSGO.METHOD.SELECT&&(e=[]);var g=[],g=b.collection instanceof GenericObjectCollection?b.collection.objects.slice():b.collection.slice(),
l=0;for(i in g)if("*"==a||g instanceof a||g[i].header.className==a){if(d.process(g[i]))switch(b.query.type){case JSGO.METHOD.SELECT:e.push(b.selectedAttributes(g[i]));break;case JSGO.METHOD.UPDATE:var k=b.__whenUpdate(b.query.selection,i),e=e?!0:k;break;case JSGO.METHOD.DELETE:b.collection.objects.splice(l,1);l--;e=!0;break;default:throw Error("Query type doesn't exist. Use the JSGO.METHOD enum");}l++}null!=b.orderby&&b.__whenOrderBy(e,b.orderby.attribute,b.orderby.order);return e};if(b.query.type==
JSGO.METHOD.UPDATE)return e.Set=function(){var a={};b.query.updateTo=arguments;a.run=k;return a},e;b.query.type==JSGO.METHOD.SELECT&&(e.OrderBy=function(a,c){var d={};b.orderby={attribute:a,order:c};d.run=k;return d});e.run=k;return e};return d}};
...
GenericObjectCollection.Filter.prototype.process=function(a){var b=!1,c=null,c=-1!=this.attribute.indexOf(".")?GenericObjectCollection.Query.deepSearch(this.attribute,a):a instanceof GenericObject?a[this.attribute].get():a[this.attribute];switch(this.operator){case JSGO.OPERATOR.EQ:c==this.value&&(b=!0);break;case JSGO.OPERATOR.GTE:c>=this.value&&(b=!0);break;case JSGO.OPERATOR.MTE:c<=this.value&&(b=!0);break;case JSGO.OPERATOR.GT:c>this.value&&(b=!0);break;case JSGO.OPERATOR.MT:c<this.value&&(b=
!0);break;case JSGO.OPERATOR.LIKE:this.value instanceof RegExp&&this.value.test(c)&&(b=!0);break;default:throw Error("Operator "+this.operator+" doesn't exists");}if(1<(null!=this.or)+(null!=this.and)+(null!=this.xor))throw Error("Filter using more than one logic conector.");return null!=this.or?b||this.or.process(a):null!=this.and?b&&this.and.process(a):null!=this.xor?(a=this.xor.process(a),b&&!a||!b&&a):b};
